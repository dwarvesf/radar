...
// TagInfo returns the tags details of the given tags.
func (session Session) TagInfo(tags []string, params map[string]string) (output *Tags, error error) {
	request_path := strings.Join([]string{"tags", strings.Join(tags, ";"), "info"}, "/")
